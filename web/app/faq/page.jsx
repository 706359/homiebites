  ...
  const faqs = [
    {
      ...
      answer: t('faq.a1') || 'You can place an order through our website by adding items to your cart and proceeding to checkout, or contact us directly via WhatsApp.',
    },
    {
      question: t('faq.q2') || 'What are your delivery timings?',
      answer: t('faq.a2') || 'We deliver daily. Last order time is 7:30 PM, and delivery is completed by 8:30 PM.',
    },
    {
      question: t('faq.q3') || 'What areas do you deliver to?',
      answer: t('faq.a3') || 'We currently deliver to Panchsheel Greens, A1-A5 Towers, B1-B3 Towers, and nearby societies.',
    },
    {
    ...
    },
    {
      ...
      answer: t('faq.a5') || 'Yes! We offer Mix & Match options where you can choose your preferred combination of sabji, rotis, and rice.',
    },
    {
      question: t('faq.q6') || 'Do you offer subscription plans?',
      answer: t('faq.a6') || 'Yes, we offer monthly subscription plans. Contact us for more details.',
    },
    {
      question: t('faq.q7') || 'What if I need to cancel my order?',
      answer: t('faq.a7') || 'Please contact us at least 2 hours before delivery time to cancel your order.',
    },
    {
      question: t('faq.q8') || 'Is the food vegetarian?',
      answer: t('faq.a8') || 'Yes, all our food is 100% vegetarian and prepared with fresh ingredients.',
    },
  ];
