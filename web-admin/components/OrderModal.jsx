...
import { getFirstError, hasValidationErrors, validateOrder } from '../lib/formValidation';
...
const OrderModal = ({ isOpen, onClose }) => {
  ...
  const handleWhatsAppOrder = () => {
    ...
    const formData = {
      ...
      customerPhone,
      deliveryAddress,
      quantity: Object.values(orderItems).reduce((sum, qty) => sum + qty, 0),
      unitPrice:
        getTotalPrice() / (Object.values(orderItems).reduce((sum, qty) => sum + qty, 0) || 1),
    };
