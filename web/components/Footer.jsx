...
const Footer = ({ onOrderClick }) => {
  ...
  const handleNewsletterSubmit = (e) => {
    ...
    const subscriptions = JSON.parse(
      localStorage.getItem("homiebites_newsletter") || "[]",
    );
    const emailExists = subscriptions.some(
      (sub) => sub.email === newsletterEmail.toLowerCase(),
    );
    ...
    <footer>
      <div className="footer-inner">
        ...
        <div className="footer-actions">
          <Link className="btn btn-secondary btn-small" to="/menu">
            {t("footer.viewMenu")}
          </Link>
          <button className="btn btn-primary btn-small" onClick={onOrderClick}>
            {t("footer.orderNow")}
          </button>
        </div>
      </div>
        ...
        <div className="footer-column footer-newsletter">
          ...
          >
            <input
              type="email"
              placeholder={
                t("footer.newsletterPlaceholder") || "Enter your email"
              }
