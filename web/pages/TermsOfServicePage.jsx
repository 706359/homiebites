        ...
        <div className='legal-container'>
          ...
          <div className='legal-content'>
            <section id='section-1' className='legal-section'>
              ...
              <p>
                By accessing and using HomieBites ("we," "our," or "us") website and services, you
                agree to be bound by these Terms of Service and all applicable laws and regulations.
                If you do not agree with any of these terms, you are prohibited from using our
                services.
              </p>
            </section>
            ...
            <section id='section-2' className='legal-section'>
              ...
              <p>
                HomieBites provides a tiffin (meal) delivery service offering home-cooked vegetarian
                meals. We deliver to specified areas including Panchsheel Greens and nearby
            ...
            <section id='section-4' className='legal-section'>
              ...
              <ul>
                <li>Orders must be placed at least 1 hour before delivery time (7:30 PM)</li>
              ...
              <ul>
                <li>We accept Cash on Delivery (COD), UPI, and online payments</li>
                <li>Payment is due at the time of delivery for COD orders</li>
                <li>Online payments are processed through secure third-party gateways</li>
              ...
              <ul>
                <li>
                  Orders can be cancelled up to 2 hours before delivery time for a full refund
                </li>
                <li>Late cancellations may incur charges</li>
                <li>Refunds for online payments will be processed within 5-7 business days</li>
                <li>No refunds for delivered orders unless there is a quality issue</li>
              </ul>
            </section>
            ...
            <section id='section-5' className='legal-section'>
              ...
              <ul>
                <li>
                  <strong>Delivery Areas:</strong> We deliver to Panchsheel Greens (A1-A5, B1-B3
                  Towers) and nearby areas within a 2km radius
                </li>
                <li>
                  <strong>Delivery Time:</strong> Daily between 7:30 PM - 8:30 PM
                </li>
                <li>
                  <strong>Delivery Charges:</strong> Free delivery on orders ₹100 and above. ₹20
                  charge for orders below ₹100
                </li>
                <li>
                  <strong>Self-Pickup:</strong> Available from A1-405, Panchsheel Greens
                </li>
                <li>
            ...
            <section id='section-6' className='legal-section'>
              ...
              <ul>
                <li>All food is prepared fresh daily using quality ingredients</li>
                <li>We follow strict hygiene and food safety standards</li>
                <li>All meals are 100% vegetarian</li>
                <li>
                  If you have food allergies or dietary restrictions, please inform us before
                  ordering
                </li>
                <li>
                  We are not liable for allergic reactions if allergens are not disclosed by the
                  customer
                </li>
              </ul>
            </section>
            ...
            <section id='section-8' className='legal-section'>
              ...
              <p>
                ...
                is the property of HomieBites or its licensors and is protected by copyright and
            ...
            <section id='section-10' className='legal-section'>
              ...
              <p>
                You agree to indemnify and hold harmless HomieBites, its officers, directors,
            ...
            <section id='section-11' className='legal-section'>
              ...
              <p>
                ...
                party for any modification, suspension, or discontinuance of services.
              </p>
            </section>
