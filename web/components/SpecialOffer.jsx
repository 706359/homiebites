  ...
  return (
    <section className="offer-section">
      <div className="section-container">
        <p className="offer-intro">{t('specialOffer.intro') || 'for busy professionals and families'}</p>
        <button className="btn btn-primary btn-large" onClick={handleGetDeal}>{t('specialOffer.getDeal')}</button>
