...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        t("faq.a4") ||
        "We accept cash on delivery, online payments, and UPI payments.",
    },
    {
    ...
    },
    {
      ...
      answer:
        t("faq.a6") ||
        "Yes, we offer monthly subscription plans. Contact us for more details.",
    },
    {
    ...
    },
    {
      ...
      answer:
        t("faq.a8") ||
        "Yes, all our food is 100% vegetarian and prepared with fresh ingredients.",
    },
  ];
      ...
      <div className="faq-page">
        <div className="faq-container">
          <h1 className="faq-title">
            {t("header.faq") || "Frequently Asked Questions"}
          </h1>
