        ...
        <div className="legal-page">
          <div className="legal-container">
            ...
            <section className="legal-section">
              ...
              <p>
                Welcome to HomieBites. HomieBites is a local kitchen operation, not a registered
                restaurant or firm. We respect your privacy and are committed to protecting your
            ...
            <section className="legal-section">
              ...
              <ul>
                ...
                <li>
                  <strong>Order Information:</strong> Details about your orders, including items
                  ordered, quantities, and payment information
                </li>
                <li>
