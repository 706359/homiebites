          ...
          <div className="legal-content">
            <section id="section-1" className="legal-section">
              ...
              <p>
                ...
                HomieBites makes no representations or warranties of any kind,
            ...
            <section id="section-2" className="legal-section">
              ...
              <p>
                While we take every precaution to ensure food safety and
                hygiene, HomieBites cannot guarantee that our food products are
                free from allergens, contaminants, or other substances that may
                cause adverse reactions. Customers with food allergies, dietary
              ...
              <p>
                HomieBites shall not be liable for any allergic reactions,
                foodborne illnesses, or health issues arising from the
                consumption of our products, except where such issues result
                directly from our negligence or failure to follow food safety
                standards.
              </p>
            </section>
            ...
            <section id="section-3" className="legal-section">
              ...
              <p>
                HomieBites strives to deliver orders within the specified time
                window (7:30 PM - 8:30 PM). However, we are not responsible for
                delays caused by:
              </p>
              <ul>
              ...
              <p>
                We will make reasonable efforts to notify customers of delays
                and work to resolve delivery issues promptly.
              </p>
            </section>
            ...
            <section id="section-4" className="legal-section">
              ...
              <p>
                Nutritional information provided on our website or in
                communications is approximate and based on standard recipes and
                ingredients. Actual nutritional values may vary based on:
              </p>
              <ul>
              ...
              <p>
                ...
                should not be considered medical or dietary advice. Customers
                with specific nutritional needs should consult with healthcare
                professionals.
              </p>
            </section>
            ...
            <section id="section-5" className="legal-section">
              ...
              <p>
                While we strive to keep our website accessible and operational,
                HomieBites does not guarantee uninterrupted or error-free
                access. The website may be temporarily unavailable due to:
              </p>
              <ul>
            ...
            <section id="section-6" className="legal-section">
              ...
              <p>
                HomieBites is not responsible for the availability, accuracy, or
                practices of these third-party services. Your use of third-party
                services is subject to their respective terms and conditions and
                privacy policies.
              </p>
            </section>
            ...
            <section id="section-7" className="legal-section">
              ...
              <p>
                Prices displayed on our website are subject to change without
              ...
              <p>
                While we make every effort to ensure accurate pricing, errors
                may occur. We reserve the right to correct pricing errors and
            ...
            <section id="section-8" className="legal-section">
              ...
              <p>
                Our website may allow users to submit reviews, comments, or
                other content. HomieBites does not endorse or assume
                responsibility for user-generated content. We reserve the right
                to:
              </p>
              <ul>
                ...
                <li>
                  Use user content for promotional purposes (with attribution)
                </li>
              </ul>
            </section>
            ...
            <section id="section-9" className="legal-section">
              ...
              <p>
                To the fullest extent permitted by law, HomieBites, its
            ...
            <section id="section-10" className="legal-section">
              ...
              <p>
                The information provided by HomieBites, including nutritional
                information and dietary guidance, is for general informational
                purposes only and is not intended as medical advice, diagnosis,
                or treatment. Always seek the advice of qualified health
                professionals regarding any medical condition or dietary
                concerns.
              </p>
              <p>
                Do not disregard professional medical advice or delay seeking it
                because of information obtained from our website or services.
              </p>
            </section>
            ...
            <section id="section-11" className="legal-section">
              ...
              <p>
                HomieBites shall not be liable for any failure or delay in
                performance under these terms resulting from acts beyond our
