...
export const defaultMenuData = [
  {
    ...
    items: [
      { id: 1, name: '1 Full Tiffin', price: 120 },
      // Mix & Match Tiffin section
      { id: 2, name: 'Mix & Match Tiffin - 2 Sabji + 6 Rotis', price: 120 },
      { id: 3, name: 'Mix & Match Tiffin - 1 Sabji + 4 Rotis + Rice', price: 100 },
      ...
      { id: 7, name: 'Mix & Match Tiffin - 1 Sabji + 2 Bowls Rice', price: 100 },
...
export const triggerDataSync = () => {
  ...
  if (typeof window !== 'undefined' && window.localStorage) {
    ...
    localStorage.setItem('homiebites_menu_update_trigger', Date.now().toString())
    setTimeout(() => {
