        ...
        <div className='legal-container'>
          ...
          <div className='legal-content'>
            <section id='section-1' className='legal-section'>
              ...
              <p>
                Welcome to HomieBites ("we," "our," or "us"). We are committed to protecting your
            ...
            <section id='section-4' className='legal-section'>
              ...
              <ul>
                <li>
                  ...
                  business (payment processors, delivery partners, email services)
                </li>
                <li>
            ...
            <section id='section-6' className='legal-section'>
              ...
              <p>
                ...
                <a href='mailto:privacy@homiebites.com'>privacy@homiebites.com</a> or{' '}
                <a href='https://wa.me/919958983578'>WhatsApp: +91-9958983578</a>.
              </p>
            </section>
            ...
            <section id='section-7' className='legal-section'>
              ...
              <p>
                ...
                settings, but disabling cookies may limit certain features of our website.
              </p>
            </section>
            ...
            <section id='section-12' className='legal-section'>
              ...
              <ul>
                <li>
                  <strong>Email:</strong>{' '}
                  <a href='mailto:privacy@homiebites.com'>privacy@homiebites.com</a>
                </li>
                <li>
