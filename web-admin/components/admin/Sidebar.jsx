...
const Sidebar = ({
  ...
  const autoHideSidebar = useMemo(() => {
    ...
    return settings.autoHideSidebar !== undefined &&
    ...
    <>
      ...
      <div
        className={`admin-sidebar ${sidebarOpen ? 'open' : ''} ${
          ...
          showProfileDropdown ? 'profile-dropdown-open' : ''
        }`}
      ...
      >
        <div className="sidebar-scroll">
          <div className="sidebar-header">
            <div
              className={`sidebar-logo ${logoImgError ? 'logo-img-error' : ''}`}
            >
              <img
                src="/logo.png"
                alt="HomieBites"
              ...
              {settings && (
                <span
                  ...
                  title={
                    getKitchenStatus(settings)
                      ? 'Kitchen is Open'
                      : 'Kitchen is Closed'
                  }
                  style={{
                    backgroundColor: getKitchenStatus(settings)
                      ? '#10b981'
                      : '#ef4444',
                  }}
